...
static int asn_err_no = 0;
static const char *asn_errors[3] = {
    "Encoding ASN.1 Information",   /* 0 */
    "Decoding ASN.1 Information",   /* 1 */
    "Unknown Error"
};
const char *
asn_err_str(int err_no)
{
    if ( err_no > 2 || err_no < 0 )
    {
        err_no = 2;
    }
    return asn_errors[err_no];
}

void
asn_error(int err_no)
{
    asn_err_no = err_no;
}
