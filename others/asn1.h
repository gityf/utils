#ifndef _UTILS_ASN1_H
#define _UTILS_ASN1_H
...
/* max subid's in an oid, per X spec. */
...
#define ERR_ASN_ENCODE 0
#define ERR_ASN_DECODE 1
...
extern "C" {
    ...
    const char *asn_err_str(int err_no);
    void asn_error(int err_no);
    int asn_errno();
